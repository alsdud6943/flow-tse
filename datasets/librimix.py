...
# def standardize_audio(audio_tensor):
#     """Normalizes audio to have a standard deviation of 1."""
#     # Subtracting mean is optional but good practice
#     # audio_tensor = audio_tensor - torch.mean(audio_tensor)
#     std = torch.std(audio_tensor)
#     if std > 0:
#         return audio_tensor / std
#     return audio_tensor
